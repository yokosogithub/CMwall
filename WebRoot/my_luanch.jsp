...
<<<<<<< HEAD
	   	   ...
	   	   <div class="row">
		   	   <div class="col-xs-2">
			   	   <h3><span class="glyphicon glyphicon-map-marker" style="float:right;color:#428bca"></span></h3>
		   	   </div>
		   	   <div class="col-xs-10" style="margin-top:20px">
			   	   <input id="input_locationlabel" type="text" class="form-control" placeholder="我的位置(例：艺术码头、文科楼B座)">
		   	   </div>
	   	   </div>
	   	   <br>
	   	   <br>
